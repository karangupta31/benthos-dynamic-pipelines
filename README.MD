...
The generated job is run as a benthos streams process, in a seperate process, which is running in parallel to the controller. We can call this the benthos worker.
